...
import (
	...
	"github.com/tminor/lspsonnet/implementation"
)
...
var command = &cobra.Command{
	Use:   toolName,
	Short: "Start the Jsonnet language server",
	PersistentPreRun: func(cmd *cobra.Command, args []string) {
		...
		// Don't log Jsonnet
		logging.SetLevel(logging.INFO, "jsonnet.grammars.tosca_v2_0")
		logging.SetLevel(logging.INFO, "jsonnet.parser")
